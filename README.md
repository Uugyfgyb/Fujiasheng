...
<body>
    ...
    <nav class="glass-nav sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-4">
                    ...
                    <a href="#mars" data-nav-link="mars" class="nav-link px-3 py-2 rounded-md text-sm font-medium text-gray-300 transition-all duration-300" data-lang-key="nav.mars">火星前哨</a>
        ...
        <div id="mobile-menu" class="sm:hidden hidden glass-nav border-t border-gray-700">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="#mars" data-nav-link="mars" class="nav-link block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-800" data-lang-key="nav.mars">火星前哨</a>
    ...
    <main class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                            ...
                            <p class="text-gray-300 text-sm leading-relaxed" data-lang-key="home.intro_content">
                             ...
                             <div class="mt-4 pt-4 border-t border-white/10 text-sm text-gray-400">
                                <div class="flex items-center gap-2 mb-1">
                                    <svg class="w-4 h-4 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                    <span>felix.fu@mail.utoronto.ca</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                                    <span>WeChat/Tel: 18200475850</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- 新增模块：火星任务 -->
        <section id="mars" class="page-section">
            <h2 class="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-500" data-lang-key="mars.title">火星登陆前哨</h2>
            <p class="text-lg text-gray-300 mb-8" data-lang-key="mars.desc">美国火星探索核心任务与企业活动梳理：</p>
            
            <div class="space-y-8">
                <!-- NASA 板块 -->
                <div class="glass-card p-8 rounded-xl border border-red-500/20">
                    <div class="flex items-center mb-6">
                        <div class="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-xl mr-4">NASA</div>
                        <h3 class="text-2xl font-bold text-white">NASA - Moon to Mars Strategy</h3>
                    </div>
                    <div class="space-y-6 text-gray-300">
                        <div class="border-l-2 border-blue-500 pl-4">
                            <h4 class="text-lg font-semibold text-blue-300 mb-2" data-lang-key="mars.nasa.artemis">阿尔忒弥斯计划 (Artemis Program)</h4>
                            <p class="mb-2">作为火星任务的前奏，旨在重返月球并建立Gateway空间站，验证深空生存技术。</p>
                            <ul class="list-disc list-inside text-sm text-gray-400">
                                <li>Artemis II (2024/25): 载人绕月飞行。</li>
                                <li>Artemis III (2025+): 载人登陆月球南极。</li>
                            </ul>
                        </div>
                        <div class="border-l-2 border-red-500 pl-4">
                            <h4 class="text-lg font-semibold text-red-300 mb-2" data-lang-key="mars.nasa.msr">火星采样返回 (Mars Sample Return)</h4>
                            <p class="mb-2">与ESA合作，毅力号 (Perseverance) 正采集样本，计划于2030年代初将火星岩石带回地球。</p>
                        </div>
                        <div class="border-l-2 border-orange-500 pl-4">
                            <h4 class="text-lg font-semibold text-orange-300 mb-2" data-lang-key="mars.nasa.tech">关键技术研发</h4>
                            <p class="text-sm">包括核热推进 (NTP) 发动机研发，以缩短地球到火星的航行时间。</p>
                        </div>
                    </div>
                </div>

                <!-- SpaceX 板块 -->
                <div class="glass-card p-8 rounded-xl border border-gray-500/30">
                    <div class="flex items-center mb-6">
                        <div class="w-12 h-12 rounded-full bg-gray-800 flex items-center justify-center text-white font-bold text-xl mr-4">X</div>
                        <h3 class="text-2xl font-bold text-white">SpaceX - Making Life Multi-Planetary</h3>
                    </div>
                    <div class="space-y-6 text-gray-300">
                        <div class="border-l-2 border-gray-400 pl-4">
                            <h4 class="text-lg font-semibold text-gray-200 mb-2" data-lang-key="mars.spacex.starship">星舰 (Starship)</h4>
                            <p class="mb-2">史上最大运载火箭，完全可重复使用，专为火星殖民设计。</p>
                            <ul class="list-disc list-inside text-sm text-gray-400">
                                <li>主要测试地：Starbase, Texas。</li>
                                <li>近期进展：轨道试飞测试 (IFT) 快速迭代中，验证热防护与回收技术。</li>
                            </ul>
                        </div>
                        <div class="border-l-2 border-gray-400 pl-4">
                            <h4 class="text-lg font-semibold text-gray-200 mb-2" data-lang-key="mars.spacex.timeline">火星时间表</h4>
                            <p class="text-sm">Musk 设想在未来窗口期首先发射无人货运飞船，随后进行载人登陆，目标是在火星建立自给自足的城市。</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- 其他商业航天 -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <div class="glass-card p-6 rounded-xl border border-purple-500/20">
                        <h4 class="text-xl font-bold text-purple-300 mb-3">Relativity Space / Impulse Space</h4>
                        <p class="text-sm text-gray-400 mb-2">Impulse Space 与 Relativity Space 曾宣布联合开展火星登陆任务 (Mars Lander)，旨在成为首个登陆火星的商业载荷。</p>
                    </div>
                    <div class="glass-card p-6 rounded-xl border border-cyan-500/20">
                        <h4 class="text-xl font-bold text-cyan-300 mb-3">Blue Origin</h4>
                        <p class="text-sm text-gray-400 mb-2">虽然主要聚焦于近地轨道和月球 (Blue Moon)，但 New Glenn 火箭也是重型运载工具，具备深空探测潜力，是美国深空生态的重要一环。</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        const resourceData = [
            ...
            // --- 核心知识 (原PDF 现改为 Web Link 或 Placeholder) ---
            { title: "Calculus Cheat Sheet", desc: "Derivatives & Integrals.", desc_cn: "微积分速查表 (导数与积分)。", type: "web", link: "https://tutorial.math.lamar.edu/pdf/Calculus_Cheat_Sheet_All.pdf" },
            { title: "Physics Constants", desc: "Fundamental constants.", desc_cn: "物理常数表 (光速, 普朗克常数)。", type: "web", link: "https://physics.nist.gov/cuu/Constants/" },
            { title: "Periodic Table HD", desc: "High-res printable.", desc_cn: "高清元素周期表。", type: "web", link: "https://ptable.com/" },
            { title: "Amino Acids Chart", desc: "Structures & properties.", desc_cn: "氨基酸结构与性质表。", type: "web", link: "https://www.sigmaaldrich.com/life-science/metabolomics/learning-center/amino-acid-reference-chart.html" },
            { title: "Standard Model", desc: "Fundamental particles.", desc_cn: "粒子物理标准模型图。", type: "web", link: "https://home.cern/science/physics/standard-model" },
            { title: "Trig Identities", desc: "Sin, Cos, Tan rules.", desc_cn: "三角函数恒等式大全。", type: "web", link: "https://en.wikipedia.org/wiki/List_of_trigonometric_identities" },
            { title: "Organic Reactions", desc: "Reaction map.", desc_cn: "有机化学反应路线图。", type: "web", link: "https://www.masterorganicchemistry.com/reaction-guide/" },
            { title: "Maxwell's Equations", desc: "Electromagnetism core.", desc_cn: "麦克斯韦方程组详解。", type: "web", link: "http://hyperphysics.phy-astr.gsu.edu/hbase/electric/maxeq.html" },
            { title: "Metabolic Pathways", desc: "Cellular respiration.", desc_cn: "细胞代谢通路图。", type: "web", link: "http://biochemical-pathways.com/" },
            { title: "SI Units", desc: "International system.", desc_cn: "国际单位制换算表。", type: "web", link: "https://www.nist.gov/pml/weights-and-measures/metric-si" },
        ...
        const translations = {
            en: {
                ...
                "resources.link": "View Link",
                "mars.title": "Mars Horizon",
                "mars.desc": "Overview of US Mars exploration activities and progress:",
                "mars.nasa.artemis": "Artemis Program",
                "mars.nasa.msr": "Mars Sample Return",
                "mars.nasa.tech": "Key Technologies",
                "mars.spacex.starship": "Starship",
                "mars.spacex.timeline": "Timeline to Mars",
            ...
            cn: {
                ...
                "home.intro_content": "欢迎登舰！我是这艘知识飞船的驾驶员——付嘉圣 (Jiasheng Fu Felix)。我热衷于解开宇宙的方程，无论是微积分的无限奥秘，还是化学键的微观舞蹈。这里没有枯燥的死记硬背，只有对真理的无尽探索。让我们一起向着未知的知识疆域进发！",
                "subject.math": "数学",
                ...
                "resources.link": "访问链接",
                "mars.title": "火星登陆前哨",
                "mars.desc": "美国火星探索核心任务与企业活动梳理：",
                "mars.nasa.artemis": "阿尔忒弥斯计划 (Artemis Program)",
                "mars.nasa.msr": "火星采样返回 (Mars Sample Return)",
                "mars.nasa.tech": "关键技术研发",
                "mars.spacex.starship": "星舰 (Starship)",
                "mars.spacex.timeline": "火星时间表",
                "ai.title": "AI 量子解析",
        ...
        function renderResources() {
            ...
            resourceData.forEach(item => {
                ...
                const actionColor = 'text-blue-400 hover:text-blue-300';
                const icon = '🔗';
